        ...
        try:
            ...
            payload = {
                "player_status": {
                    ...
                    "monthly_income": getattr(self.player_status, 'monthly_income', 0),
                    "monthly_expense": getattr(self.player_status, 'monthly_expense', 0),
                    "savings": getattr(self.player_status, 'savings', 0),
                    "debt": getattr(self.player_status, 'debt', 0),
                    "stock_investment": getattr(self.player_status, 'stock_investment', 0),
                    "bond_investment": getattr(self.player_status, 'bond_investment', 0),
                    "cash_investment": getattr(self.player_status, 'cash_investment', 0),
                    "real_estate_investment": getattr(self.player_status, 'real_estate_investment', 0),
                    "is_married": getattr(self.player_status, 'is_married', False),
                    "children": getattr(self.player_status, 'children', 0),
                    "has_house": getattr(self.player_status, 'has_house', False),
                },
                "investment_config": {
                    ...
                    "young_growth_ratio": getattr(self.investment_config, 'young_growth_ratio', 0.0),
                    "young_conservative_ratio": getattr(self.investment_config, 'young_conservative_ratio', 0.0),
                    "young_cash_reserve_ratio": getattr(self.investment_config, 'young_cash_reserve_ratio', 0.0),
                    "middle_growth_ratio": getattr(self.investment_config, 'middle_growth_ratio', 0.0),
                    "middle_conservative_ratio": getattr(self.investment_config, 'middle_conservative_ratio', 0.0),
                    "middle_cash_reserve_ratio": getattr(self.investment_config, 'middle_cash_reserve_ratio', 0.0),
                    "old_growth_ratio": getattr(self.investment_config, 'old_growth_ratio', 0.0),
                    "old_conservative_ratio": getattr(self.investment_config, 'old_conservative_ratio', 0.0),
                    "old_cash_reserve_ratio": getattr(self.investment_config, 'old_cash_reserve_ratio', 0.0),
                    "growth_return_rate": getattr(self.investment_config, 'growth_return_rate', 0.07),
                    "conservative_return_rate": getattr(self.investment_config, 'conservative_return_rate', 0.03),
                    "cash_return": getattr(self.investment_config, 'cash_return', 0.02),
                },
                "salary_config": {
                    "young_growth_rate": getattr(self.salary_config, 'young_growth_rate', 0.05),
                    "middle_growth_rate": getattr(self.salary_config, 'middle_growth_rate', 0.02),
                    "senior_decline_rate": getattr(self.salary_config, 'senior_decline_rate', 0.1),
                    "young_age_limit": getattr(self.salary_config, 'young_age_limit', 35),
                    "middle_age_limit": getattr(self.salary_config, 'middle_age_limit', 50),
                    "decline_age": getattr(self.salary_config, 'decline_age', 55),
                },
